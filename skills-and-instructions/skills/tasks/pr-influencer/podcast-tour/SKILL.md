---
name: podcast-tour
description: This skill should be used when the user asks to "get on podcasts", "podcast outreach", "podcast tour", "secure podcast appearances", or mentions podcast guesting, podcast pitching, or podcast PR. Creates strategic podcast outreach campaigns that secure high-value podcast appearances and build authority.
---
...
1. **Research:** Find podcasts where you can provide genuine value
2. **Personalize:** Show you understand their show and audience
3. **Pitch Value:** Focus on what you'll deliver, not what you want
4. **Follow Up:** Persistent but respectful follow-up
