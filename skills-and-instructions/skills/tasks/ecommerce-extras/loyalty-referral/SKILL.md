...
1. **Give Value:** Reward customers for desired behaviors
2. **Create Habit:** Make program easy to understand and use
3. **Build Community:** Foster connection between brand and customers
4. **Drive Growth:** Turn customers into advocates and referrers
...
• You get: $20 credit when they make their first purchase
• They get: 15% off their first order

How it works:
1. Share your unique referral link: [link]
2. Friend uses link and makes purchase
3. You both get rewarded automatically
...
✓ Free shipping at Silver tier (500 points)

Start earning today! [Shop Now]

Your current points: 0
Next reward at: 100 points ($10 off)"
```
