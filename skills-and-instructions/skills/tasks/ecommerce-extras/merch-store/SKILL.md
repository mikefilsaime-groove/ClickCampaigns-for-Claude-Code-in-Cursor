---
name: merch-store
description: This skill should be used when the user asks to "set up a merch store", "create print-on-demand shop", "sell t-shirts/mugs", "merchandise strategy", or mentions Printful, Printify, Shopify Merch, or influencer merchandise. Creates strategic plans for selling physical brand assets.
---
...
1. **The Hero Product:** A single item (e.g., Hoodie) that represents the peak of the brand.
2. **The Essentials:** T-shirts, hats, and stickers for lower-friction entry points.
3. **The Limited Drop:** Creating scarcity with "seasonal" or "event-only" merch.
...
```text
"Not your average cheap giveaway tee. Our 'Standard Issue' 
heavyweight t-shirt is built for comfort and designed to last. 
Features a custom hand-drawn graphic on 100% premium cotton. 
Tailored fit. Pre-shrunk. Ready for the long haul."
```
