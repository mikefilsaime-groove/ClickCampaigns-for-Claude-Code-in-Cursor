...
description: This skill should be used when the user asks to "create Facebook ads", "write ad copy", "build paid ad campaigns", "Meta ads", "Google ads", "TikTok ads", or mentions paid advertising, social media ads, or PPC campaigns. Creates high-performing ad copy and creative guidance across platforms.
---
...
```
[Hook - 0-3 seconds]
"I paid off $47K in debt in 90 days..."

[Story - 3-15 seconds]
"And no, I didn't get a raise or win the lottery.
I just discovered this ONE strategy that nobody talks about.
It's called the debt snowball hack..."

[CTA - 15-20 seconds]
"Link in bio to get my free guide showing exactly how I did it."
```
