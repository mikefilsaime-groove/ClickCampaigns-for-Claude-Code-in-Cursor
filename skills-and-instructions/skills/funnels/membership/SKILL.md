...
description: This skill should be used when the user asks to "create a membership funnel", "build a subscription funnel", "membership sales page", "recurring revenue funnel", or mentions memberships, subscriptions, or recurring billing funnels. Creates membership funnels that convert prospects and retain members long-term.
---
...
Subject: 🎉 Welcome to [Membership Name]! Here's your access
...
1️⃣ **Log into the member area**
   → [LOGIN LINK]
   Your email: {email}
   (You set your password during checkout)

2️⃣ **Join the private community**
   → [COMMUNITY LINK]
   Introduce yourself! We'd love to meet you.

3️⃣ **Watch the "Start Here" video**
   → [VIDEO LINK]
